...
public class FilterEvaluatorTests
{
    ...
    public void Gt_Integers(int fieldValue, int filterValue, bool expected)
    {
    ...
    [InlineData(3, 3, true)]
    [InlineData(1, 3, false)]
    public void Gte_Integers(int fieldValue, int filterValue, bool expected)
    {
    ...
    public void Lt_Integers(int fieldValue, int filterValue, bool expected)
    {
    ...
    [InlineData(3, 3, true)]
    [InlineData(5, 3, false)]
    public void Lte_Integers(int fieldValue, int filterValue, bool expected)
    {
    ...
    {
        var row = new object?[] { "r1", "Alice", 50 };
    ...
    {
        var row = new object?[] { "r1", "Alice", 30 };
        var filters = new List<FilterSpec>
        {
            new("name", FilterOperator.Eq, "Alice"),
            new("score", FilterOperator.Gte, 40)
