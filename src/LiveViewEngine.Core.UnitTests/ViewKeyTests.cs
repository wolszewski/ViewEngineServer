...
public class ViewKeyTests
{
    ...
    {
        var a = new ViewKey("orders", "price", true, null);
        var b = new ViewKey("orders", "price", true, null);
        Assert.Equal(a, b);
    }
    ...
    {
        var a = new ViewKey("orders", "price", true, null);
        var b = new ViewKey("products", "price", true, null);
        Assert.NotEqual(a, b);
    }
    ...
    {
        var a = new ViewKey("orders", "price", true, null);
        var b = new ViewKey("orders", "amount", true, null);
        Assert.NotEqual(a, b);
    }
    ...
    {
        var a = new ViewKey("orders", "price", true, null);
        var b = new ViewKey("orders", "price", false, null);
        Assert.NotEqual(a, b);
    }
    ...
    public void Equals_DifferentFilters_ReturnsFalse()
    {
        ...
        var a = new ViewKey("orders", null, true, fa);
        var b = new ViewKey("orders", null, true, fb);
        Assert.NotEqual(a, b);
    }
    ...
    {
        var key = new ViewKey("orders", null, true, null);
    ...
    public void CanBeUsedAsDictionaryKey()
    {
        ...
        var key1 = new ViewKey("c", "f", true, null);
        var key2 = new ViewKey("c", "f", true, null);
        dict[key1] = "value";
